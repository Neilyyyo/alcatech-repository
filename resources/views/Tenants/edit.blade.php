...
<div class="min-h-screen bg-orange-50 p-8">
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-orange-600">Edit Tenant</h1>
        ...
        <form action="{{ route('tenants.update', $tenant->id) }}" method="POST">
            ...
            <!-- Guardian Name -->
            <div class="mb-4">
                <label for="guardian_name" class="block text-sm font-medium text-gray-700">Guardian Name and Contact #:</label>
                <input type="text" name="guardian_name" value="{{ old('guardian_name', $tenant->guardian_name) }}" 
